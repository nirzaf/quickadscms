...
;(function(window, document, plupload, o, $) {
    ...
    function renderUI(obj) {
        ...
        obj.html(
            ...
            '<div class="plupload_header_title">' + LANG_PREVIEW + '</div>' +
            '<div class="plupload_header_text hidden">' + LANG_ADD_FILES_TEXT + '</div>' +
            ...
            '<tr>' +
            '<td class="plupload_cell plupload_file_name">' + LANG_FILENAME + '</td>' +
            '<td class="plupload_cell plupload_file_status">' + LANG_STATUS + '</td>' +
            '<td class="plupload_cell plupload_file_size">' + LANG_SIZE + '</td>' +
            '<td class="plupload_cell plupload_file_action">&nbsp;</td>' +
            '</tr>' +
            '</table>' +

            '<div class="plupload_content">' +
            '<div class="plupload_droptext hidden-xs">' + LANG_DRAG_FILES_HERE + '</div>' +
            ...
            '<a class="plupload_button plupload_add theme-bg-color">' + LANG_ADD_FILES + '</a>&nbsp;' +
            '<a class="plupload_button plupload_start">' + LANG_SEND + '</a>&nbsp;' +
            '<a class="plupload_button plupload_stop plupload_hidden">'+ LANG_STOP_UPLOAD + '</a>&nbsp;' +
            '</div>' +
