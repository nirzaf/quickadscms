    ...
    <div class="container">
        <div class="breadcrumb-section">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{LANG_PENDING_ADS}</li>
                            ...
                            <div class="collapse-box">
                                ...
                                <div id="MyAds" class="panel-collapse collapse in">
                                    <ul class="acc-list">
                                        ...
                                        <li class="active"><a href="{LINK_PENDINGADS}" class="waves-effect"><i class="fa fa-info-circle"></i> {LANG_PENDING_ADS}<span class="badge">{PENDINGADS}</span></a></li>
                    ...
                    <div class="my-quickad section">
                        ...
                        <table id="js-table-list" class="manage-table responsive-table">
                            ...
                            <tr class="ajax-item-listing" data-item-id="{ITEM.id}">
                                ...
                                <td class="action" width="12%"><a href="{LINK_EDIT-AD}/{ITEM.id}"><i class="fa fa-pencil"></i> {LANG_EDIT}</a><a class="delete item-js-delete" href="#" data-ajax-action="deleteMyAd"><i class="fa fa-remove"></i> {LANG_DELETE}</a></td>
                            </tr>
                            {/LOOP: ITEM}
                            </tbody>
                        </table>
