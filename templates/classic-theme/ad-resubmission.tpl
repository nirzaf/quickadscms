    ...
    <div class="container">
        <div class="breadcrumb-section">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{LANG_RESUBMITED_ADS}</li>
                            ...
                            <div class="collapse-box">
                                ...
                                <div id="MyAds" class="panel-collapse collapse in">
                                    <ul class="acc-list">
                                        ...
                                        <li class="active"><a href="{LINK_RESUBMITADS}" class="waves-effect"><i class="fa fa-briefcase"></i> {LANG_RESUBMITED_ADS} <span class="badge">{RESUBMITADS}</span></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="collapse-box">
                ...
                <div class="col-sm-9 page-content">
                    <div class="my-quickad section">
                        ...
                        <table id="js-table-list" class="manage-table responsive-table">
                            ...
                            <td class="item-status" width="12%"><span class="label label-info">{LANG_RESUBMITED}</span></td>
                            <td class="action" width="12%"><a class="delete item-js-delete" href="#" data-ajax-action="deleteResumitAd"><i class="fa fa-remove"></i> {LANG_DELETE}</a></td>
                            </tr>
                            {/LOOP: ITEM}
                            </tbody>
                        </table>
